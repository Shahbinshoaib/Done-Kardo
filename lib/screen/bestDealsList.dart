...
class BestDealsList extends StatefulWidget {
  @override
  _BestDealsListState createState() => _BestDealsListState();
}
    ...
    return StreamBuilder<List<Farm>>(
      ...
      builder: (context, snapshot){
        if (snapshot.hasData){
          ...
          var farm =  farm2.where((p) => ('${p.category}').contains('Best Deals')).toList();
                ...
                child: ButtonTheme(
                  ...
                  child: RaisedButton(
                    onPressed: (){
                      showSearch(
                        context: context,
                        delegate: CustomSearchDelegate(farm2: farm.toList()),
                      );
                    },
                    elevation: 3.0,
                            ...
                            child: Card(
                                ...
                                child: FlatButton(
                                  onPressed: (){
                                    ...
                                    Navigator.of(context).push(AdminPanel1(farm.toList()[index]));
                                    setState(() {
                                      loader = false;
                                    });
                                  },
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Stack(
                                          ...
                                          children: [
                                            ...
                                            Image.network(farm.toList()[index].pic1 ??  'https://i.pinimg.com/originals/a3/a7/f4/a3a7f4d0f800028e6aed6dae054744fd.gif',
                                              height: h*0.15,
                                              fit: BoxFit.fill,
                                              width: w*0.30,),
                                          ],
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              child: Text(farm.toList()[index].title,style: TextStyle(fontWeight: FontWeight.bold,fontSize: h*0.02,color: Colors.black),),
                                              width: w*0.6,),
                ...
                child: FlatButton(
                  ...
                  child: Row(
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(10.0),
                        child: Image.network(farm.toList()[index].pic1 ??  'https://i.pinimg.com/originals/a3/a7/f4/a3a7f4d0f800028e6aed6dae054744fd.gif',
                          height: h*0.15,
                          fit: BoxFit.fill,
                          width: w*0.30,),
                      ),
